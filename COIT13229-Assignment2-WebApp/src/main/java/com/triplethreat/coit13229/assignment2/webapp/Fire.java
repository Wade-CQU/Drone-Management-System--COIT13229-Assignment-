...
@Table(name = "fire")
@NamedQueries({
    @NamedQuery(name = "Fire.findAll", query = "SELECT f FROM Fire f ORDER BY f.intensity DESC"),
...
public class Fire implements Serializable {
    ...
    public String toString() {
        return "com.triplethreat.coit13229.assignment2.webapp.Fire[ id=" + id + "intense=" + intensity + " ]";
    }
